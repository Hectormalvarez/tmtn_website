...
const mockRepo1 = {
  id: 100,
  name: 'tmtn_website',
  url: 'https://api.github.com/repos/Hectormalvarez/tmtn_website',
};
const mockRepo2 = {
  id: 101,
  name: 'humblelibrarysync',
  url: 'https://api.github.com/repos/Hectormalvarez/humblelibrarysync',
};
const mockRepo3 = {
  id: 102,
  name: 'laphost',
  url: 'https://api.github.com/repos/Hectormalvarez/laphost',
};
...
export const mockRepos: Repo[] = [
  {
    ...
    homepage: 'https://taylormadetech.net',
    forks_count: 1,
    archived: false,
  },
  {
  ...
  },
  {
    ...
    language: 'TypeScript',
    topics: ['nlp', 'generator'],
    stargazers_count: 8,
    fork: false,
    pushed_at: new Date((now - 7 * DAY) * 1000).toISOString(),
    created_at: '2024-03-01T14:00:00Z',
    homepage: 'https://genwords.taylormadetech.net',
    forks_count: 2,
    archived: false,
  },
  {
...
export const mockEvents: GitHubEvent[] = [
  {
    ...
    payload: {
      ...
      ref: 'refs/heads/main',
      head: 'abc123def456',
      before: '000aaa111bbb222',
      commits: [
        {
          sha: 'abc123',
          message: 'feat: add contribution heatmap',
          author: { name: 'Hector', email: 'h@test.com' },
        },
        {
          sha: 'def456',
          message: 'test: add heatmap render tests',
          author: { name: 'Hector', email: 'h@test.com' },
        },
        {
          sha: 'ghi789',
          message: 'style: refine heatmap colors',
          author: { name: 'Hector', email: 'h@test.com' },
        },
      ],
    },
  ...
  },
  {
    ...
    payload: {
      ...
      pull_request: {
        id: 5001,
        title: 'Add activity timeline component',
        html_url: 'https://github.com/Hectormalvarez/tmtn_website/pull/14',
        state: 'open',
        merged: false,
        body: 'Implements the activity feed UI.',
      },
    },
    public: true,
  ...
  },
  {
    ...
    payload: {
      ...
      release: {
        ...
        name: 'Version 1.0.0',
        html_url:
          'https://github.com/Hectormalvarez/laphost/releases/tag/v1.0.0',
...
function buildCommitActivity(): CommitActivityWeek[] {
  ...
  for (let i = 0; i < 52; i++) {
    ...
    const zero: [number, number, number, number, number, number, number] = [
      0, 0, 0, 0, 0, 0, 0,
    ];
    ...
    if (i < 21) {
      ...
      const d: [number, number, number, number, number, number, number] = [
        0,
        2 + (i % 3),
        1 + (i % 2),
        3,
